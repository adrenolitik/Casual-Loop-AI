...
const TEMPLATES = [
  {
    title: 'Здравоохранение: Очереди в поликлиниках и выгорание врачей',
    domain: 'Медицинский менеджмент и общественное здоровье',
    problem: 'Исследование замкнутого круга: нехватка времени на прием ведет к недолечиванию, росту повторных обращений, перегрузке врачей и их увольнению.',
    icon: HeartPulse,
  },
  {
    title: 'Рынок недвижимости: Ипотечные субсидии и взрывной рост цен на жилье',
    domain: 'Экономика градостроительства и финансы',
    problem: 'Анализ стимулирования спроса через льготную ипотеку при жестком лаге предложения нового жилья и эффекта вымывания доступности.',
    icon: TrendingUp,
  },
  {
    title: 'Open Source экосистема: Ментейнеры, выгорание и кибербезопасность',
    domain: 'Инженерия ПО и управление открытыми проектами',
    problem: 'Моделирование системной хрупкости критической цифровой инфраструктуры при бесплатном использовании корпорациями и отсутствии финансирования мейнтейнеров.',
    icon: Cpu,
  },
  {
    title: 'Энергетический переход: Зеленая генерация, стабильность сетей и тарифы',
    domain: 'Энергетика и экологическая устойчивость',
    problem: 'Исследование волатильности возобновляемой энергии (солнце, ветер), необходимости резервирования мощностей и влияния на тарифы для промышленности.',
    icon: Globe,
  },
];
